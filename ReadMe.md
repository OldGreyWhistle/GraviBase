...
**Audience:** Public; scientific researchers (theoretical physics, cosmology, gravitation); engineers (technical-documentation discipline; corpus-management methodology); LLM-assisted research practitioners.

**In scope:**
- Methodology framework — Stream 3 corpus-bounded discipline; modal-status preservation; audit-trail integrity; framing-bias correction (bidirectional); controlled-synthesis-injection vs uncontrolled-synthesis-creep distinction
- Three-index navigation architecture — Context Definitions (Index 1), Context Relationships (Index 2), Metric Units (Index 3)
- 22-framework Theme C deep-pass audit covering Wheeler-tradition geometrodynamics, modified-gravity baryogenesis, emergent-gravity programmes, pilot-wave-class frameworks, and analogue-gravity laboratory work
- 31 deep-review reports including Theme C foundational reviews, post-cycle paper deeppasses, and Item-phenomenon substantive reviews
- Worked example: UMF Trial S3M0S1 substantive content at current state

**Out of scope:**
- UMF v0.7 / v2.3 source-content technical development (engagement requires explicit author direction)
...
└── GraviBase/                         (main project folder)
    ...
    ├── UMF_Trial_S3M0S1_Index2_ContextRelationships_v1.md (65 relational entries)
    ├── UMF_Trial_S3M0S1_Index3_MetricUnits_v1.md       (32 metric units)
    ├── VC Amendment files (Amendment 7 through Amendment 13)
    ├── companion-documents/           (Addendum; Spec v3; Scaffold v8; Research Plan v0.7; Handoff v8; Introduction Letter v2; predecessor Drafts)
    ├── deep-review-reports/           (31 deep-review reports)
    └── version-control/               (master VC running file v1.1; VC Amendment files)
```

Repository deployment uses relative paths exclusively for cross-references between files; this ensures portability across GitHub web UI, local markdown viewers, and any git clone.
